...
const VERDICT_WORDS: Record<Verdict, string> = {
  mismatch: "does not match the official source. Say plainly that it did not come from that organization.",
  matches_official:
